...
session_start();
  ...
  else
  {
                ...
                $obj_pdf->SetTitle("RESTAURANT zamówienia");  
                ...
                if($since == $to)
                {
                    $content .= '<h3 align="center">Zamówienia RESTAURANT '.$since.'</h3><br /><br />'; 
                }else{
                    $content .= '<h3 align="center">Zamówienia RESTAURANT od '.$since.' do '.$to.'</h3><br /><br />'; 
                }
